    ...
    <style>
        ...
        @media screen and (max-width: 480px) {
            ...
            .content-box-text-img {
                ...
                width: 180px;
                height: 130px;
                background-image: url("./static/images/mobile-404.png");
                background-size: 100% 100%;
...
<div class="download-title">
    ...
    <div class="top-box-center">
        <#--<span class="top-box-rule rule-public">DApp</span>
        <span class="top-box-Notice Notice-public">公告</span>
        <span class="top-box-me me-public">帮助</span>-->
    </div>
    <div class="top-box-lang ">
        <img src="./static/images/Hong Kong.png" alt="" class="top-lang-img">
        <img src="./static/images/arrow.png" alt="" class="arrow">
        <div class="top-lang-center" style="display: none">
            <img src="./static/images/Hong Kong.png" alt="" class="top-lang-zh">
            <img src="./static/images/mw.png" alt="" class="top-lang-en">
        </div>
    </div>
</div>
<!--  头部end  -->
...
<div class="content-box">
    <div class="content-box-text">
        ...
        <div>404</div>
        <div class="non-existent">您的访问页面可能被删除或者不存在</div>
        <div>
...
<script>
	...
	let Language = {
		...
		'.non-existent': {zh: '您的访问页面可能被删除或者不存在', en: 'Your access page may be deleted or may not exist'},
